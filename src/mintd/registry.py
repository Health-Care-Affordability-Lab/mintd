...
class LocalRegistry:
    ...
    def _write_catalog_entry(self, catalog_entry: Dict[str, Any], project_name: str) -> Path:
        ...
        type_dir = {'data': 'data', 'project': 'projects', 'code': 'code'}[project_type]
...
"""
    ...
    def check_registration_status(self, project_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            for project_type in ["data", "project", "code"]:
                catalog_path = self.repo_path / 'catalog' / {'data': 'data', 'project': 'projects', 'code': 'code'}[project_type] / f"{project_name}.yaml"
    ...
    def _fetch_catalog_entry(self, project_name: str) -> Tuple[Dict[str, Any], Path]:
        ...
        type_dirs = {'data': 'data', 'project': 'projects', 'code': 'code'}
