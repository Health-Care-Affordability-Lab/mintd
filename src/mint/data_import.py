"""Data import functionality for mint - pull and import DVC-tracked data.
...
class ImportTransaction:
    ...
    def __init__(self, project_path: Path):
        ...
        self.state_file = project_path / ".mint" / "import_state.json"
...
def validate_project_directory(project_path: Path) -> None:
    ...
    if not metadata_file.exists():
        raise DataImportError(
            f"Not a mint project directory. Missing metadata.json in {project_path}"
        )
